...
const ConnectedAddressContext = createContext<
  ConnectedAddressContextType | undefined
>(undefined);
...
export const ConnectedAddressProvider: React.FC<
  ConnectedAddressProviderProps
> = ({ children }) => {
...
export const useConnectedAddress = () => {
  ...
  if (context === undefined) {
    throw new Error(
      "useConnectedAddress must be used within a ConnectedAddressProvider"
    );
  }
  return context;
};
